...
namespace FreakLete.Api.Migrations
{
    ...
    [Migration("20260429183507_AddRagEmbeddings")]
    partial class AddRagEmbeddings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreakLete.Api.Entities.ExerciseSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FreakLete.Api.Entities.UserSnapshotEmbedding", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("UserSnapshotEmbeddings");
                });
            ...
            modelBuilder.Entity("FreakLete.Api.Entities.WorkoutEmbedding", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FreakLete.Api.Entities.ExerciseSet", b =>
                {
                    b.HasOne("FreakLete.Api.Entities.ExerciseEntry", "ExerciseEntry")
                        .WithMany("Sets")
